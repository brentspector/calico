...
type FelixConfigurationSpec struct {
	...
	// NetworkLogFilePath is the full path to the syslog location. [Default: /var/log/syslog]
	NetworkLogFilePath string `json:"networkLogFilePath,omitempty"`

	// NetworkLogFormat is the output format of the nework logs generated by Calico. [Default: syslog]
	// +kubebuilder:validation:Pattern=`^(?i)(Syslog|Json)?$`
	NetworkLogFormat string `json:"networkLogFormat,omitempty" validate:"omitempty,syslogJson"`
